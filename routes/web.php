...
Route::get('/', function () {
    ...
    return view('home.index', compact('agendas', 'komentars'));
});
...
// index admin route komentar
Route::middleware(['admin'])->group(function () {
Route::get('/admin/komentar', [KomentarController::class, 'index'])->name('admin.komentar.index');
});
